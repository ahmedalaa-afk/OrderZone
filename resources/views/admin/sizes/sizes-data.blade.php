<div>
    <div class="mb-3">
        ...
        @if ($showArchived)
        <button class="btn btn-primary" wire:click="showArchivedSizes">
            Active Sizes <i class="bx bx-list-ul me-1"></i>
        </button>
        @else
        <button type="submit" class="btn btn-secondary" wire:click="showArchivedSizes">
            Archived Sizes <i class="bx bx-trash me-1"></i>
        </button>
        @endif
    </div>
    @if (count($sizes) > 0)
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                @if ($size->deleted_at)
                                <a class="dropdown-item" href="#"
                                    wire:click.prevent="$dispatch('restoreSize', { id: {{ $size->id }} })">
