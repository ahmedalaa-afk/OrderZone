...
<script>
    ...
    document.addEventListener('livewire:init', () => {
        Livewire.on('updateCategory', (event) => {
            $('#updateCategoryModal').modal('toggle');
        });
    });
    document.addEventListener('livewire:init', () => {
        Livewire.on('updateDepartment', (event) => {
            $('#updateDepatmentModal').modal('toggle');
        });
    });
    document.addEventListener('livewire:init', () => {
        Livewire.on('updateSize', (event) => {
            $('#updateSizeModal').modal('toggle');
        });
    });
    document.addEventListener('livewire:init', () => {
    ...
    document.addEventListener('livewire:init', () => {
        Livewire.on('updateColor', (event) => {
            $('#updateColorModal').modal('toggle');
        });
    });
    document.addEventListener('livewire:init', () => {
        Livewire.on('updateTag', (event) => {
    ...
    document.addEventListener('livewire:init', () => {
        Livewire.on('deleteBrandModal', (event) => {
            $('#deleteModal').modal('toggle');
        });
    });
    document.addEventListener('livewire:init', () => {
    ...
    document.addEventListener('livewire:init', () => {
        Livewire.on('deleteColorModal', (event) => {
            $('#deleteModal').modal('toggle');
        });
    });
    document.addEventListener('livewire:init', () => {
