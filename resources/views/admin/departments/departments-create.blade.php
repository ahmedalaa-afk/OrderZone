<x-show-modal id="createDepartmentModal" title="New Department">
    <form wire:submit.prevent="submit" method="post">
        <div class="row">
            ...
            <div class="col-6">
                ...
                <input type="text" class="form-control" id="description" wire:model="description" wire:model='description'>
